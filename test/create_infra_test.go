...
func TestDeployment(t *testing.T) {
   ...
   test_structure.RunTestStage(t, "singlesite_controller_tests", func() {
      ...
      for index, controller := range controllerIPs {
         ...
         http_helper.HttpGetWithRetry(t, url, {InsecureSkipVerify: true}, 200, "avi", 10, 10*time.Second)
         http_helper.HttpGetWithRetry(t, badUrl, {InsecureSkipVerify: true}, 404, "avi", 10, 10*time.Second)
